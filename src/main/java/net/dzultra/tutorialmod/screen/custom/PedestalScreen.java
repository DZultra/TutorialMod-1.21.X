...
public class PedestalScreen extends HandledScreen<PedestalScreenHandler> {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        RenderSystem.setShader(GameRenderer::getPositionTexProgram); // Generic Thing to do 1
        RenderSystem.setShaderColor(1f, 1f, 1f, 1f); // Generic Thing to do 2
        RenderSystem.setShaderTexture(0, GUI_TEXTURE); // Generic Thing to do 3
