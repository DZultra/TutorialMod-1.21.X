package net.dzultra.tutorialmod.enchantment;


import net.dzultra.tutorialmod.TutorialMod;
import net.dzultra.tutorialmod.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantments {
    ...
    public static void bootstrap(Registerable<Enchantment> registerable) {
        ...
        register(registerable, LIGHTNING_STRIKER, Enchantment.builder(
